...
if __name__ == '__main__':
    ...
    logging.basicConfig(filename='../log/cifair10_split' + str(start_time), level=logging.INFO)
    ...
    logging.info("Train " + str(uniform.train_dim[0]))
    logging.info("Test " + str(uniform.test_dim[0]))
    logging.info("Val " + str(x_val.shape[0]))
